...
New-Module -Name BoxForming  -ScriptBlock {
	...
	Function New-LocalAdminUser {
		...
		New-LocalUser(-Username $Username -Password $Password -Description $Description -FullName $FullName -IsAdmin $true)
	}
	...
	Function New-LocalUser {
		...
		if ($IsAdmin) {
			...
			$Group = [System.DirectoryServices.AccountManagement.GroupPrincipal]::FindByIdentity($MachineContext, $GroupSidType, $AdminGroupSid)
